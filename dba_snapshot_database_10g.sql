...
define reportHeader="<font size=+3 color=darkgreen><b>Snapshot Database 10<i>g</i></b></font><hr>Copyright (c) 1998-2008 Jeffrey M. Hunter. All rights reserved. (<a target=""_blank"" href=""http://www.idevelopment.info"">www.idevelopment.info</a>)<p>"
...
<td nowrap align="center" width="25%"><a class="link" href="#flashback_database_log_files">Flashback Database Log Files</a></td> -
</tr> -
<tr> -
...
SELECT
  ...
  , DECODE(   a.status
            ...
            ,             '<div align="center"><b><font color="#663300">'   || status || '</font></b></div>' ) status
  , DECODE(   a.schedule
            , 'ACTIVE',   '<div align="center"><b><font color="darkgreen">' || status || '</font></b></div>'
            , 'INACTIVE', '<div align="center"><b><font color="#990000">'   || status || '</font></b></div>'
            ,             '<div align="center"><b><font color="#663300">'   || status || '</font></b></div>' ) schedule
  , a.archiver                                archiver
...
prompt <a name="flashback_database_log_files"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Flashback Database Log Files</b></font><hr align="left" width="460">

CLEAR COLUMNS BREAKS COMPUTES

COLUMN instance_name            FORMAT a75                HEADING 'Instance Name'    ENTMAP off
COLUMN sequence#                                          HEADING 'Sequence #'       ENTMAP off 
COLUMN name                     FORMAT a125               HEADING 'Log File Name'    ENTMAP off
COLUMN log#                                               HEADING 'Log #'            ENTMAP off
COLUMN bytes                    FORMAT 999,999,999,999    HEADING 'Bytes'            ENTMAP off
COLUMN first_change#                                      HEADING 'First Change #'   ENTMAP off
COLUMN first_time               FORMAT a75                HEADING 'First Time'       ENTMAP off
...
SELECT
    '<div align="center"><font color="#336699"><b>' || i.instance_name || '</b></font></div>'  instance_name
  , l.sequence#
  , l.name
  , l.log#
  , l.bytes
  , l.first_change#
  , '<div align="right">' || TO_CHAR(l.first_time,'mm/dd/yyyy HH24:MI:SS') || '</div>'  first_time
FROM
    gv$flashback_database_logfile l
  , gv$instance  i
WHERE
    l.inst_id = i.inst_id
ORDER BY
...
prompt Provides a summary report of all dynamic components as part of Oracle's Automatic Shared Memory
...
prompt As with the other manageability features of Oracle Database 10<i>g</i>, ASMM requires you to set the 
...
prompt Oracle10<i>g</i> introduces the trcsess command-line utility to combine prompt all the relevant
...
BREAK ON report ON table_name

SELECT
    '<b><font color="#336699">' || table_name || '</font></b>'  table_name
  , grantee       grantee
  , privilege     privilege
  , '<div align="center">' || grantable || '</div>'  grantable
FROM
    dba_tab_privs
WHERE
...
SELECT
  ...
  , '<div nowrap align="center">' || NVL(can_undrop, '<br>') || '</div>'  can_undrop
  , '<div nowrap align="center">' || NVL(can_purge, '<br>')  || '</div>' can_purge
